...
(function () {
  ...
  /**
    ...
    * View element calls jSelectCRUD when a CRUD is clicked
    * jSelectCRUD creates the link tag, sends it to the editor,
    * and closes the select frame.
    */

  window.jSelectCRUD = function (id, title, catid, object, link, lang) {
    var hreflang = '';

    if (!Joomla.getOptions('xtd-CRUDs')) {
      // Something went wrong
      window.parent.Joomla.Modal.getCurrent().close();
      return false;
    }

    var _Joomla$getOptions = Joomla.getOptions('xtd-CRUDs'),
